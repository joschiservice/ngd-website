...
export default function NewLandingPage() {
  return (
    <PublicLayout title="Blog" hoverNavbar={false}>
      <Box display="flex" sx={{height: "500px", position: "relative"}}>
        <Image alt="news title image" src={KiaEv6DriftImage} fill={true} style={{objectFit: "cover", objectPosition: "50% 50%"}} priority />
        <Box p="xl" sx={{background: "rgba(0,0,0,0.6)", height: "100%", width: "100%", display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", zIndex: 2}}>
